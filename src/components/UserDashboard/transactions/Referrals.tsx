...
import rightArrow from "../../../assets/icons/arrow_back_ios_new.svg";
import leftArrow from "../../../assets/icons/arrow_forward_ios.svg";
        ...
        <div className=" p-[16px] border-[#E5E5E5] border-[1px] rounded-xl shadow-md bd-nrm-reg">
            <table className="w-full text-sm text-left text-gray-700">
                ...
                <tbody>
                    <tr className="bg-white border-0">
                        ...
                        <td className="px-4 py-2">
                            <div className="flex items-center gap-2">
                                <span className="bd-nrm-reg text-[#1D1D1D]">0xA8B3...EeB90</span>
                                <FaRegCopy size={16} className="cursor-pointer text-gray-500 hover:text-gray-700" title="Copy" />
                            </div>
                        </td>

                        <td className="px-4 py-2">
                            <div className="flex items-center gap-2">
                                <span className="bd-nrm-reg text-[#1D1D1D]">0x7A23...EfC92</span>
                                <FaRegCopy size={16} className="cursor-pointer text-gray-500 hover:text-gray-700" title="Copy" />
                                <IoMdLink size={16} className="cursor-pointer text-gray-500 hover:text-gray-700" title="Open link" />
                            </div>
                        </td>
                        <td className="px-4 py-2">
                            <div className="flex items-center gap-2">
            ...
            <div className="flex justify-center items-center mt-4 text-[#8E8E8E] space-x-2">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button className="px-4 py-2 border border-[#E5E5E5] rounded">2</button>
                    <button className="px-4 py-2 border border-[#E5E5E5] rounded">3</button>
                    <button className="px-4 py-2 border border-[#E5E5E5] rounded">5</button>
                    <span className="px-2">...</span>
                    <button className="px-4 py-2 border border-[#E5E5E5] rounded">40</button>
                </div>
