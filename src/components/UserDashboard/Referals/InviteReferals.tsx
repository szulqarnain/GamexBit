        ...
        <div className="w-full h-[200px] gap-[32px] flex flex-col">
          <div className="w-full h-[84px] gap-[12px] flex flex-col">
            ...
            <div className="relative w-full h-[60px]">
              <input className="w-full h-[60px] gap-auto px-[16px] border-[2px] rounded-[12px]" value="GXB14S"/>
          ...
          <div className="w-full h-[84px] gap-[12px] flex flex-col">
            ...
            <div className="relative w-full h-[60px]">
              <input className="w-full h-[60px] gap-auto px-[16px] border-[2px] rounded-[12px]" value="https://app.gamexbit.com/sponser?ref=AhmerIlyas">
              </input>
              <div className="absolute right-[16px] top-[20px]">
                <MdOutlineContentCopy className="text-[#A8AEBA]" />
              </div>
