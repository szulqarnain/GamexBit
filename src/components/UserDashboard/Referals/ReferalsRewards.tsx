        ...
        <div className="w-auto h-[158px] gap-[32px] flex flex-col">
          <div className="w-auto h-auto gap-[26px] flex flex-col lg:flex-row">
            <div className="w-[247px] h-[63px] gap-[16px] flex flex-col">
              <div className=" h-[24px] gap-[8px] flex flex-row">
                <img src={Diamond} className="w-[24px] h-[24px]" />
                <p className=" text-[rgb(var(--primary-text))] bd-lrg-med">
                  Total Points
                </p>
              </div>
          ...
          <div className="w-auto h-auto gap-[26px] flex flex-col lg:justify-between lg:flex-row">
            <div className="h-[63px] gap-[16px] flex flex-col">
              <div className="w-[205px] h-[24px] gap-[8px] flex flex-row">
                <AiOutlinePercentage
                  color="#953BFF"
                  className="w-[24px] h-[24px]"
                />
                <p className="bd-lrg-med w-full  text-[rgb(var(--primary-text))]">
                  My Commission Rate
                </p>
              </div>
              <p className="heading-4 text-[rgb(var(--primary-text))]">
                0.0001
              </p>
            </div>
            <div className="w-[247px] h-[63px] gap-[16px] flex flex-col">
