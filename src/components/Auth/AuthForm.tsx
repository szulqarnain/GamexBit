...
const AuthForm: React.FC<AuthFormProps> = ({ mode }) => {
    return (
        <div className= {`${styles.authFormContainer} mx-auto w-[664px] p-[60px]`}>
            <img src={brandLogo} alt="Gamexbit" className="w-[200px] mx-auto pb-[56px]" />
            <form className="">
                <div className="flex flex-col gap-[6px] pb-[32px]">
                    <label className="bd-nrm-med text-secondary">Email</label>
                    <input className="p-[16px] border-[2px] rounded-[12px]"
                        type="email"
                ...
                <button type="submit" className={`${styles.authBtn} w-full p-[16px] rounded-[12px] mt-[42px]`}>
                    Sign In
                </button>
            </form>
        </div>
